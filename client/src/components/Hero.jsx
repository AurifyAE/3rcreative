...
export default function Hero() {
    return (
        <div className='relative w-full overflow-hidden pb-32 md:pb-56'>
            ...
            <div className='w-full bg-black lg:bg-transparent -mt-1 md:-mt-44 lg:mt-0 lg:absolute md:bottom-0 lg:bottom-125 z-20 text-white font-[productSans] py-20 md:py-0 space-y-15'>
            ...
            <div className='w-5/6 absolute bottom-20 md:bottom-30 lg:bottom-70 left-1/2 translate-x-[-50%] z-20 lg:text-3xl text-center font-[jmhTypewriter] text-[#E76F51]'>
            ...
            <div className='relative w-full rotate-180 z-10'>
                <img src={tornPage} alt="" className='w-full absolute -top-30 md:-top-65 lg:-top-50 rotate-180 z-10' />
            </div>
        </div>
    )
}
